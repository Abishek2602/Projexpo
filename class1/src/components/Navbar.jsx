...
const Navbar = ({ isLoggedIn, setIsLoggedIn }) => {
  ...
  return (
    <nav className="nav-div">
      ...
      <div className="flex gap-8 text-blue-600 text-sm font-oswald">
      ...
      <span className="absolute top-0 left-0 w-full bg-gradient-to-b from-white to-transparent rounded-extra-lg opacity-5 h-1/3"></span>
      ...
      <span className="absolute w-0 h-0 transition-all duration-300 ease-out bg-white rounded-super-lg group-hover:w-56 group-hover:h-56 opacity-5"></span>
