    ...
    <div className="flex items-center justify-center h-screen w-full px-5 sm:px-0 bg-gray-900">
      <div className="flex font-oswald bg-opacity-80 shadow-intense overflow-hidden max-w-sm lg:max-w-4xl w-full rounded-extra-lg" data-aos='zoom'>
        ...
        <div className="w-full p-8 lg:w-1/2">
          ...
          <form onSubmit={handleLogin} className="mt-4 flex flex-col justify-between">
            ...
            <div className="mt-8">
              <button className="rounded-extra-lg bg-blue-700 text-white font-bold py-2 px-4 w-full rounded hover:bg-blue-600" type="submit">Login</button>
            </div>
            <a href="#" className="flex items-center justify-center mt-4 text-white rounded-extra-lg shadow-md hover:shadow-intense hover:shadow-black">
              <div className="flex px-5 justify-center w-full py-3 border rounded-extra-lg">
            ...
            <div className="mt-4 flex items-center w-full text-center">
              <a href="#" className="text-xs text-gray-500 capitalize text-center w-full">Don&apos;t have any account yet? <span className="text-blue-700">Sign Up</span></a>
            </div>
          </form>
        </div>
      </div>
