        ...
        <div className="flex items-center justify-center h-screen w-full px-5 sm:px-0 bg-gray-900">
          <div className="flex font-oswald bg-opacity-80 shadow-intense overflow-hidden max-w-sm lg:max-w-4xl w-full rounded-extra-lg" data-aos='zoom'>
            ...
            <div/>
              ...
              <div className="mt-8">
                <button className="rounded-extra-lg bg-blue-700 text-white font-bold py-2 px-4 w-full rounded hover:bg-blue-600">
                  Login
                </button>
              </div>
              <a
                href="#"
                className=" flex items-center justify-center mt-4 text-white rounded-extra-lg shadow-md hover:shadow-intense hover:shadow-black"
              >
